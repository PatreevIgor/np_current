...
class CandiesControllerTest < ActionController::TestCase
  ...
  test "should create candy" do
    assert_difference('Candy.count') do
      post :create, candy: { image: @candy.image, manufacturer: @candy.manufacturer, title: @candy.title }
    end
  ...
  test "should update candy" do
    patch :update, id: @candy, candy: { image: @candy.image, manufacturer: @candy.manufacturer, title: @candy.title }
    assert_redirected_to candy_path(assigns(:candy))
  end
